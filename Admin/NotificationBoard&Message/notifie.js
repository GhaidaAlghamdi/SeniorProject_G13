    ...
    get(child(dbRef, `Parent`)).then((snapshot) => {
        if (snapshot.exists()) {
            ...
            snapshot.forEach((childSnapshot) => {
                ...
                document.getElementById('tdBody').innerHTML += '<tr><td>"' + data["name"] + '"</td><td>Salazar Rayo</td><td><span class="status green"></span> Arrived </td></tr>';
            });
        } else {
...
/*
                  ...
                  <tr>
                      ...
                      <td>Ciro Ledesma</td>
                      <td>
                          <span class="status red"></span> not Arrived
                      </td>
                  </tr>
